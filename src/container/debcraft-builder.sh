...
# Instead of the debuild-style '<package>_<version>_<arch>.build' filename use
# plain 'build.log' for consistency across builds and directory diffs
BUILD_LOG="build.log"
...
then
  ...
  GBP_ARGS="--git-no-create-orig --git-ignore-new"
